...
/**
 * Session class
 * Save or read data from the current session
 */
...
class Session
{
    ...
    // get data from the session. the default is return if data not found
    ...
    // gets data from a column in the session useer data
    ...
    // returns all data from the APP(or $this->mainkey) array
